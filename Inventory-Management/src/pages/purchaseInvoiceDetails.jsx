...
export default function PurchaseInvoiceDetails() {
    ...
    const getCategories = () => {
        axios.get('https://localhost:7190/api/PurchaseInvoiceDetails')
            .then(result => {
    ...
    return (
        <Grid container spacing={2}>
            <Grid style={{ marginTop: '40px' }} item xs={12} md={12}>
                <h2 className='pull-top'>Purchase Invoice Details</h2>
            </Grid>
                            ...
                            rowData.map((item) => {
                                return (
                                    <tr key={item.catId}>
                                        ...
                                        <td >
                                            {item.pidproductQuantity}
                                        </td>
                                        <td >
                                            {item.pidproductTotalPrice}
                                        </td>
                                        <td >
                                            {item.pidperUnitPrice}
                                        </td>
                        
                                       
                                        <td>
                                            <Button style={{backgroundColor:'black'}} className='pull-right'// onClick={() => { assignVal(item.catId) }} 
                                            variant="contained">Update</Button> |&nbsp;
                                            <Button style={{backgroundColor:'black'}} className='pull-right' //onClick={() => deleteCategories(item.catId)} 
